...
class Agent():
    ...
    def learn(self, step, experiences, gamma, d=1):
        ...
        # print(next_states.requires_grad)
        # print(dones.requires_grad)
        # exit()
        
        # ---------------------------- update critic ---------------------------- #
        # Get predicted next-state actions and Q values from target models
        # print(self.actor_local.fc1.weight.requires_grad)
        next_action, log_pis_next = self.actor_local.evaluate(next_states)
        # print(next_action.requires_grad)
        # print(log_pis_next.requires_grad)
        # exit()
