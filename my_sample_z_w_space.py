...
def sample():
    ...
    for i in tqdm(range(1, iter_times+1)):
        ...
        if use_z_plus_space:
            ...
            dirname = f'/home/a402-3070/storage/LZA/MI_data/stylegan_sample_zplus_{genforce_model}_{trunc_psi}_{trunc_layers}_{SIZE}'
    ...
    torch.save(all_ws, f'{dirname}/{genforce_model}_all_ws.pt')
