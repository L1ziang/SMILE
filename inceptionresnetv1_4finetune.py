...
class InceptionResnetV1_4finetune(nn.Module):
...
class InceptionResnetV1_4finetune_E(nn.Module):
    """Inception Resnet V1 model with optional loading of pretrained weights.
    ...
    Keyword Arguments:
        ...
        dropout_prob {float} -- Dropout probability. (default: {0.6})
    """
    def __init__(self, pretrained=None, classify=False, num_classes=None, dropout_prob=0.6, device=None, num_experts=None):
        super().__init__()
